...
namespace AddressableImpl
{
    public class AddressableManager
    {
        ...
        /// <returns></returns>
        public static T LoadAssetAsync<T>(string address, System.Action<T> onComplete = null) where T : Object
        {
        ...
        /// <returns></returns>
        public static T LoadAssetsAsync<T>(IEnumerable<string> addresses, System.Action<T> callback = null, System.Action<IList<T>> onComplete = null, Addressables.MergeMode mode = Addressables.MergeMode.Union, bool releaseDependenciesOnFailure = true) where T : Object
        {
